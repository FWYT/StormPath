...
public class CustomDataPermissionsEditor implements PermissionsEditor {
    ...
    private Collection<String> lookupPermissionStrings() {
        ...
        for (String key : CUSTOM_DATA.keySet())
        {
            //System.out.println("key: " + key);
            if (!key.equals("href") && !key.equals("createdAt") && !key.equals("modifiedAt") ) {
                permList.add(key + ":" + CUSTOM_DATA.get(key));
            }
        }
        /*for (String key : CUSTOM_DATA.keySet()) {
            System.out.println("KEY: " + key);
        ...
        System.out.println("GET FIELD NAME: " + value);
