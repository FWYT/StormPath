...
import StormpathShiro.src.main.java.com.stormpath.shiro.authz.CustomDataPermissionsEditor;
 ...
 * @since 0.5
 */
public class CustomDataPermissionResolver {//} implements AccountPermissionResolver {
    ...
    protected Set<String> getPermissionStrings(CustomData customData) {
        //CustomDataPermissionsEditor edit = new CustomDataPermissionsEditor(customData);
        return new CustomDataPermissionsEditor(customData)
                .setFieldName(getCustomDataFieldName())
                .getPermissionStrings();
    }
    ...
    /*public Set<Permission> resolvePermissions(Account acc)
    {
        return getPermissions(acc.getCustomData());
    }*/
