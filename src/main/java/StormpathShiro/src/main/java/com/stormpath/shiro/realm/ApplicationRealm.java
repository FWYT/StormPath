 ...
 */
package StormpathShiro.src.main.java.com.stormpath.shiro.realm;
...
import shiro.JwtAuthenticationToken;
 ...
 * <p/>
 * The {@link StormpathShiro.src.main.java.com.stormpath.shiro.authz.CustomDataPermissionsEditor CustomDataPermissionsEditor} has been provided for
...
public class ApplicationRealm extends AuthorizingRealm {
    ...
    protected final Application ensureApplicationReference() {
        if (this.application == null) {
            ...
            this.application = client.getResource(href, Application.class);
        }
    ...
    protected OAuthBearerRequestAuthentication createAuthenticationRequest(JwtAuthenticationToken token) {//UsernamePasswordToken token) {
